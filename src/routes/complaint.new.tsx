...
import { submitComplaint } from "@/backend/complaints";
...
function NewComplaintPage() {
  ...
  return (
    <CollectorLayout>
      ...
      <form onSubmit={submit} className="rounded-2xl border border-border bg-card p-5 shadow-card space-y-5">
        <div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {PRIORITIES.map((p) => {
              ...
              const tone =
                p === "High" ? "destructive" : p === "Medium" ? "warning" : "primary";
              return (
                <button
                  key={p}
                  type="button"
