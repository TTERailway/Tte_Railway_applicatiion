    ...
    <CollectorLayout>
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-card">
        ...
        <div className="grid gap-3 p-5 sm:grid-cols-2">
          <Row icon={<Mail className="h-4 w-4" />} label="Email">{profile.email}</Row>
          <Row icon={<Phone className="h-4 w-4" />} label="Mobile">{profile.mobile}</Row>
          <Row icon={<MapPin className="h-4 w-4" />} label="Base">{profile.base} Division</Row>
